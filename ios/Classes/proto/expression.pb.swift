...
struct Tophap_MapboxGl_Expression {
  ...
  var arguments: [Tophap_MapboxGl_Expression] {
  ...
  var map: Tophap_MapboxGl_MapExpression {
    get {
      if case .map(let v)? = _storage._data {return v}
      return Tophap_MapboxGl_MapExpression()
    }
    set {_uniqueStorage()._data = .map(newValue)}
  }

  var literal: Tophap_MapboxGl_Value {
    get {
      if case .literal(let v)? = _storage._data {return v}
      return Tophap_MapboxGl_Value()
    }
  ...
  enum OneOf_Data: Equatable {
    case map(Tophap_MapboxGl_MapExpression)
    case literal(Tophap_MapboxGl_Value)

  #if !swift(>=4.1)
    static func ==(lhs: Tophap_MapboxGl_Expression.OneOf_Data, rhs: Tophap_MapboxGl_Expression.OneOf_Data) -> Bool {
      switch (lhs, rhs) {
...
struct Tophap_MapboxGl_Value {
  ...
  var listValue: Tophap_MapboxGl_ListValue {
    get {
      if case .listValue(let v)? = _storage._kind {return v}
      return Tophap_MapboxGl_ListValue()
    }
  ...
  enum OneOf_Kind: Equatable {
    ...
    case boolValue(Bool)
    case listValue(Tophap_MapboxGl_ListValue)

  #if !swift(>=4.1)
    static func ==(lhs: Tophap_MapboxGl_Value.OneOf_Kind, rhs: Tophap_MapboxGl_Value.OneOf_Kind) -> Bool {
      switch (lhs, rhs) {
...
struct Tophap_MapboxGl_ListValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var values: [Tophap_MapboxGl_Value] = []
...
struct Tophap_MapboxGl_MapExpression {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var map: Dictionary<String,Tophap_MapboxGl_Expression> = [:]
...
extension Tophap_MapboxGl_Expression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _arguments: [Tophap_MapboxGl_Expression] = []
    var _data: Tophap_MapboxGl_Expression.OneOf_Data?
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3:
          var v: Tophap_MapboxGl_MapExpression?
  ...
  static func ==(lhs: Tophap_MapboxGl_Expression, rhs: Tophap_MapboxGl_Expression) -> Bool {
...
extension Tophap_MapboxGl_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _kind: Tophap_MapboxGl_Value.OneOf_Kind?
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5:
          var v: Tophap_MapboxGl_ListValue?
  ...
  static func ==(lhs: Tophap_MapboxGl_Value, rhs: Tophap_MapboxGl_Value) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tophap_MapboxGl_ListValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Tophap_MapboxGl_ListValue, rhs: Tophap_MapboxGl_ListValue) -> Bool {
...
extension Tophap_MapboxGl_MapExpression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tophap_MapboxGl_Expression>.self, value: &self.map)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.map.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Tophap_MapboxGl_Expression>.self, value: self.map, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Tophap_MapboxGl_MapExpression, rhs: Tophap_MapboxGl_MapExpression) -> Bool {
