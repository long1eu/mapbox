...
struct Tophap_MapboxGl_Style {
  ...
  var sources: [Tophap_MapboxGl_Source] {
    get {return _storage._sources}
    set {_uniqueStorage()._sources = newValue}
  }

  var layers: [Tophap_MapboxGl_Layer] {
    get {return _storage._layers}
    set {_uniqueStorage()._layers = newValue}
  }

  var transition: Tophap_MapboxGl_TransitionOptions {
    get {return _storage._transition ?? Tophap_MapboxGl_TransitionOptions()}
  ...
  var light: Tophap_MapboxGl_Style.Light {
    get {return _storage._light ?? Tophap_MapboxGl_Style.Light()}
  ...
  struct Light {
    ...
    var anchor: Tophap_MapboxGl_TranslateAnchor {
      get {return _storage._anchor}
      set {_uniqueStorage()._anchor = newValue}
    }

    var position: Tophap_MapboxGl_Style.Position {
      get {return _storage._position ?? Tophap_MapboxGl_Style.Position()}
    ...
    var color: Tophap_MapboxGl_Color {
      get {return _storage._color ?? Tophap_MapboxGl_Color()}
    ...
    var positionTransition: Tophap_MapboxGl_TransitionOptions {
      get {return _storage._positionTransition ?? Tophap_MapboxGl_TransitionOptions()}
  ...
  struct Operations {
    ...
    struct Build {
      ...
      var source: Tophap_MapboxGl_Style.Operations.Build.OneOf_Source? = nil

      var `default`: Tophap_MapboxGl_Style.MapboxStyle {
        get {
      ...
      enum OneOf_Source: Equatable {
        case `default`(Tophap_MapboxGl_Style.MapboxStyle)
        case uri(String)
        case json(String)

      #if !swift(>=4.1)
        static func ==(lhs: Tophap_MapboxGl_Style.Operations.Build.OneOf_Source, rhs: Tophap_MapboxGl_Style.Operations.Build.OneOf_Source) -> Bool {
          switch (lhs, rhs) {
...
extension Tophap_MapboxGl_Style.MapboxStyle: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Tophap_MapboxGl_Style.MapboxStyle] = [
    .mapboxStreets,
    .outdoors,
    .light,
    .dark,
...
extension Tophap_MapboxGl_Style: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _sources: [Tophap_MapboxGl_Source] = []
    var _layers: [Tophap_MapboxGl_Layer] = []
    var _transition: Tophap_MapboxGl_TransitionOptions? = nil
    var _light: Tophap_MapboxGl_Style.Light? = nil
  ...
  static func ==(lhs: Tophap_MapboxGl_Style, rhs: Tophap_MapboxGl_Style) -> Bool {
...
extension Tophap_MapboxGl_Style.MapboxStyle: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Tophap_MapboxGl_Style.Light: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Tophap_MapboxGl_Style.protoMessageName + ".Light"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "anchor"),
  ...
  fileprivate class _StorageClass {
    var _anchor: Tophap_MapboxGl_TranslateAnchor = .map
    var _position: Tophap_MapboxGl_Style.Position? = nil
    var _color: Tophap_MapboxGl_Color? = nil
    var _intensity: Float = 0
    var _positionTransition: Tophap_MapboxGl_TransitionOptions? = nil
  ...
  static func ==(lhs: Tophap_MapboxGl_Style.Light, rhs: Tophap_MapboxGl_Style.Light) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Tophap_MapboxGl_Style.Position: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Tophap_MapboxGl_Style.protoMessageName + ".Position"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Tophap_MapboxGl_Style.Position, rhs: Tophap_MapboxGl_Style.Position) -> Bool {
...
extension Tophap_MapboxGl_Style.Operations: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Tophap_MapboxGl_Style.protoMessageName + ".Operations"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Tophap_MapboxGl_Style.Operations, rhs: Tophap_MapboxGl_Style.Operations) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tophap_MapboxGl_Style.Operations.Build: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Tophap_MapboxGl_Style.Operations.protoMessageName + ".Build"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Tophap_MapboxGl_Style.Operations.Build, rhs: Tophap_MapboxGl_Style.Operations.Build) -> Bool {
