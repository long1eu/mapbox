...
const Source$json = const {
  ...
  '2': const [
    ...
    const {'1': 'geoJson', '3': 2, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.GeoJson', '9': 0, '10': 'geoJson'},
    const {'1': 'image', '3': 3, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.Image', '9': 0, '10': 'image'},
    const {'1': 'raster_dem', '3': 4, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.RasterDem', '9': 0, '10': 'rasterDem'},
    const {'1': 'raster', '3': 5, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.Raster', '9': 0, '10': 'raster'},
    const {'1': 'vector', '3': 6, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.Vector', '9': 0, '10': 'vector'},
    const {'1': 'unknown', '3': 7, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.Unknown', '9': 0, '10': 'unknown'},
  ],
...
const Source_GeoJson$json = const {
  ...
  '2': const [
    ...
    const {'1': 'options', '3': 3, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.GeoJson.Options', '10': 'options'},
...
const Source_RasterDem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uri', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'uri'},
    const {'1': 'tile_set', '3': 5, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.TileSet', '9': 0, '10': 'tileSet'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
const Source_Vector$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tile_set', '3': 4, '4': 1, '5': 11, '6': '.tophap.mapbox_gl.Source.TileSet', '9': 0, '10': 'tileSet'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
