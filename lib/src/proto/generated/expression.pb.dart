...
enum Expression_Data { map, literal, notSet }
...
class Expression extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expression',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOS(1, 'operator')
    ..pc<Expression>(2, 'arguments', $pb.PbFieldType.PM,
        subBuilder: Expression.create)
    ..a<MapExpression>(3, 'map', $pb.PbFieldType.OM,
        defaultOrMaker: MapExpression.getDefault,
        subBuilder: MapExpression.create)
    ..a<Value>(4, 'literal', $pb.PbFieldType.OM,
        defaultOrMaker: Value.getDefault, subBuilder: Value.create)
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value',
    ...
    ..aOS(3, 'stringValue')
    ..aOB(4, 'boolValue')
    ..a<ListValue>(5, 'listValue', $pb.PbFieldType.OM,
        defaultOrMaker: ListValue.getDefault, subBuilder: ListValue.create)
    ..hasRequiredFields = false;
...
class MapExpression extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MapExpression',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..m<$core.String, Expression>(1, 'map',
        entryClassName: 'MapExpression.MapEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: Expression.create,
        packageName: const $pb.PackageName('tophap.mapbox_gl'))
    ..hasRequiredFields = false;

  MapExpression._() : super();
  factory MapExpression() => create();
  factory MapExpression.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MapExpression.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  MapExpression clone() => MapExpression()..mergeFromMessage(this);
  MapExpression copyWith(void Function(MapExpression) updates) =>
      super.copyWith((message) => updates(message as MapExpression));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MapExpression create() => MapExpression._();
  MapExpression createEmptyInstance() => create();
  static $pb.PbList<MapExpression> createRepeated() =>
      $pb.PbList<MapExpression>();
