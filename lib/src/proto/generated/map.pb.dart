...
enum Map__Options_Style { fromMapbox, fromUri, fromJson_32, fromAsset, notSet }

class Map__Options extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Map__Options_Style>
      _Map__Options_StyleByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.Options',
    ...
    ..a<Map__CameraPosition>(4, 'cameraPosition', $pb.PbFieldType.OM,
        defaultOrMaker: Map__CameraPosition.getDefault,
        subBuilder: Map__CameraPosition.create)
    ...
    ..aOB(13, 'compass')
    ..e<$1.OrnamentPosition>(14, 'compassPosition', $pb.PbFieldType.OE,
        defaultOrMaker: $1.OrnamentPosition.TOP_LEFT,
        valueOf: $1.OrnamentPosition.valueOf,
        enumValues: $1.OrnamentPosition.values)
    ..p<$core.int>(15, 'compassMargin', $pb.PbFieldType.P3)
    ..aOB(16, 'compassFadeFacingNorth')
    ..aOB(17, 'logo')
    ..e<$1.OrnamentPosition>(18, 'logoPosition', $pb.PbFieldType.OE,
        defaultOrMaker: $1.OrnamentPosition.TOP_LEFT,
        valueOf: $1.OrnamentPosition.valueOf,
        enumValues: $1.OrnamentPosition.values)
    ..p<$core.int>(19, 'logoMargin', $pb.PbFieldType.P3)
    ..aOB(20, 'attribution')
    ..e<$1.OrnamentPosition>(21, 'attributionPosition', $pb.PbFieldType.OE,
        defaultOrMaker: $1.OrnamentPosition.TOP_LEFT,
        valueOf: $1.OrnamentPosition.valueOf,
        enumValues: $1.OrnamentPosition.values)
    ..p<$core.int>(22, 'attributionMargin', $pb.PbFieldType.P3)
    ..a<$1.Color>(23, 'attributionTintColor', $pb.PbFieldType.OM,
        defaultOrMaker: $1.Color.getDefault, subBuilder: $1.Color.create)
    ...
    ..a<$1.Color>(29, 'foregroundLoadColor', $pb.PbFieldType.OM,
        defaultOrMaker: $1.Color.getDefault, subBuilder: $1.Color.create)
    ..e<$4.Style_MapboxStyle>(30, 'fromMapbox', $pb.PbFieldType.OE,
        defaultOrMaker: $4.Style_MapboxStyle.MAPBOX_STREETS,
        valueOf: $4.Style_MapboxStyle.valueOf,
        enumValues: $4.Style_MapboxStyle.values)
    ..aOS(31, 'fromUri')
    ..aOS(32, 'fromJson')
    ..aOS(33, 'fromAsset')
  ...
  factory Map__Options.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Options.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Options clone() => Map__Options()..mergeFromMessage(this);
  Map__Options copyWith(void Function(Map__Options) updates) =>
      super.copyWith((message) => updates(message as Map__Options));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Options create() => Map__Options._();
  Map__Options createEmptyInstance() => create();
  static $pb.PbList<Map__Options> createRepeated() =>
      $pb.PbList<Map__Options>();
  ...
  set localIdeographFontFamily($core.String v) {
    $_setString(1, v);
  }
  ...
  set crossSourceCollisions($core.bool v) {
    $_setBool(2, v);
  }
  ...
  set cameraPosition(Map__CameraPosition v) {
    setField(4, v);
  }
  ...
  set scrollGestures($core.bool v) {
    $_setBool(7, v);
  }
  ...
  set rotateGestures($core.bool v) {
    $_setBool(8, v);
  }
  ...
  set doubleTapGestures($core.bool v) {
    $_setBool(10, v);
  }
  ...
  set quickZoomGestures($core.bool v) {
    $_setBool(11, v);
  }
  ...
  set compassPosition($1.OrnamentPosition v) {
    setField(14, v);
  }
  ...
  set compassFadeFacingNorth($core.bool v) {
    $_setBool(15, v);
  }
  ...
  set logoPosition($1.OrnamentPosition v) {
    setField(18, v);
  }
  ...
  set attributionPosition($1.OrnamentPosition v) {
    setField(21, v);
  }
  ...
  set attributionTintColor($1.Color v) {
    setField(23, v);
  }
  ...
  set renderTextureMode($core.bool v) {
    $_setBool(23, v);
  }
  ...
  set renderTextureTranslucentSurface($core.bool v) {
    $_setBool(24, v);
  }
  ...
  set enableTilePrefetch($core.bool v) {
    $_setBool(25, v);
  }
  ...
  set enableZMediaOverlay($core.bool v) {
    $_setBool(26, v);
  }
  ...
  set foregroundLoadColor($1.Color v) {
    setField(29, v);
  }
  ...
  set fromMapbox($4.Style_MapboxStyle v) {
    setField(30, v);
  }
...
class Map__CameraPosition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.CameraPosition',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<$core.double>(1, 'bearing', $pb.PbFieldType.OD)
    ..a<$1.LatLng>(2, 'target', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLng.getDefault, subBuilder: $1.LatLng.create)
    ..a<$core.double>(3, 'tilt', $pb.PbFieldType.OD)
    ..a<$core.double>(4, 'zoom', $pb.PbFieldType.OD)
    ..a<$1.LatLngBounds>(5, 'bounds', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLngBounds.getDefault,
        subBuilder: $1.LatLngBounds.create)
    ..hasRequiredFields = false;

  Map__CameraPosition._() : super();
  factory Map__CameraPosition() => create();
  factory Map__CameraPosition.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__CameraPosition.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__CameraPosition clone() => Map__CameraPosition()..mergeFromMessage(this);
  Map__CameraPosition copyWith(void Function(Map__CameraPosition) updates) =>
      super.copyWith((message) => updates(message as Map__CameraPosition));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__CameraPosition create() => Map__CameraPosition._();
  Map__CameraPosition createEmptyInstance() => create();
  static $pb.PbList<Map__CameraPosition> createRepeated() =>
      $pb.PbList<Map__CameraPosition>();
  static Map__CameraPosition getDefault() =>
...
class Map__Operations_Ready extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.Operations.Ready',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aInt64(1, 'viewId')
    ...
    ..a<Map__CameraPosition>(5, 'camera', $pb.PbFieldType.OM,
        defaultOrMaker: Map__CameraPosition.getDefault,
        subBuilder: Map__CameraPosition.create)
    ..a<$4.Style>(6, 'style', $pb.PbFieldType.OM,
        defaultOrMaker: $4.Style.getDefault, subBuilder: $4.Style.create)
    ..p<$core.int>(7, 'padding', $pb.PbFieldType.P3)
    ..hasRequiredFields = false;

  Map__Operations_Ready._() : super();
  factory Map__Operations_Ready() => create();
  factory Map__Operations_Ready.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_Ready.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_Ready clone() =>
      Map__Operations_Ready()..mergeFromMessage(this);
  Map__Operations_Ready copyWith(
          void Function(Map__Operations_Ready) updates) =>
      super.copyWith((message) => updates(message as Map__Operations_Ready));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_Ready create() => Map__Operations_Ready._();
  Map__Operations_Ready createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_Ready> createRepeated() =>
      $pb.PbList<Map__Operations_Ready>();
  static Map__Operations_Ready getDefault() =>
      _defaultInstance ??= create()..freeze();
  ...
  set prefetchesTiles($core.bool v) {
    $_setBool(1, v);
  }
  ...
  set camera(Map__CameraPosition v) {
    setField(5, v);
  }
...
class Map__Operations_CameraUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      'Map.Operations.CameraUpdate',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<Map__CameraPosition>(1, 'cameraPosition', $pb.PbFieldType.OM,
        defaultOrMaker: Map__CameraPosition.getDefault,
        subBuilder: Map__CameraPosition.create)
    ..a<$1.LatLng>(2, 'latLng', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLng.getDefault, subBuilder: $1.LatLng.create)
    ..a<$1.LatLngBounds>(3, 'bounds', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLngBounds.getDefault,
        subBuilder: $1.LatLngBounds.create)
    ...
    ..e<Map__Operations_CameraUpdate_Type>(11, 'operation', $pb.PbFieldType.OE,
        defaultOrMaker: Map__Operations_CameraUpdate_Type.NEW_CAMERA_POSITION,
        valueOf: Map__Operations_CameraUpdate_Type.valueOf,
        enumValues: Map__Operations_CameraUpdate_Type.values)
    ..hasRequiredFields = false;

  Map__Operations_CameraUpdate._() : super();
  factory Map__Operations_CameraUpdate() => create();
  factory Map__Operations_CameraUpdate.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_CameraUpdate.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_CameraUpdate clone() =>
      Map__Operations_CameraUpdate()..mergeFromMessage(this);
  Map__Operations_CameraUpdate copyWith(
          void Function(Map__Operations_CameraUpdate) updates) =>
      super.copyWith(
          (message) => updates(message as Map__Operations_CameraUpdate));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_CameraUpdate create() =>
      Map__Operations_CameraUpdate._();
  Map__Operations_CameraUpdate createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_CameraUpdate> createRepeated() =>
      $pb.PbList<Map__Operations_CameraUpdate>();
  static Map__Operations_CameraUpdate getDefault() =>
      _defaultInstance ??= create()..freeze();
  ...
  set operation(Map__Operations_CameraUpdate_Type v) {
    setField(11, v);
  }
...
class Map__Operations_EaseCamera extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.Operations.EaseCamera',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<Map__Operations_CameraUpdate>(1, 'update', $pb.PbFieldType.OM,
        defaultOrMaker: Map__Operations_CameraUpdate.getDefault,
        subBuilder: Map__Operations_CameraUpdate.create)
  ...
  factory Map__Operations_EaseCamera.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_EaseCamera.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_EaseCamera clone() =>
      Map__Operations_EaseCamera()..mergeFromMessage(this);
  Map__Operations_EaseCamera copyWith(
          void Function(Map__Operations_EaseCamera) updates) =>
      super.copyWith(
          (message) => updates(message as Map__Operations_EaseCamera));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<Map__Operations_EaseCamera> createRepeated() =>
      $pb.PbList<Map__Operations_EaseCamera>();
  static Map__Operations_EaseCamera getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Map__Operations_EaseCamera _defaultInstance;

  Map__Operations_CameraUpdate get update => $_getN(0);
  set update(Map__Operations_CameraUpdate v) {
    setField(1, v);
  }
  ...
  set easingInterpolator($core.bool v) {
    $_setBool(2, v);
  }
...
class Map__Operations_AnimateCamera extends $pb.GeneratedMessage {
  ...
  factory Map__Operations_AnimateCamera.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_AnimateCamera.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_AnimateCamera clone() =>
      Map__Operations_AnimateCamera()..mergeFromMessage(this);
  Map__Operations_AnimateCamera copyWith(
          void Function(Map__Operations_AnimateCamera) updates) =>
      super.copyWith(
          (message) => updates(message as Map__Operations_AnimateCamera));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_AnimateCamera create() =>
      Map__Operations_AnimateCamera._();
  Map__Operations_AnimateCamera createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_AnimateCamera> createRepeated() =>
      $pb.PbList<Map__Operations_AnimateCamera>();
  static Map__Operations_AnimateCamera getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Map__Operations_ScrollBy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.Operations.ScrollBy',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
  ...
  factory Map__Operations_ScrollBy.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_ScrollBy.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_ScrollBy clone() =>
      Map__Operations_ScrollBy()..mergeFromMessage(this);
  Map__Operations_ScrollBy copyWith(
          void Function(Map__Operations_ScrollBy) updates) =>
      super.copyWith((message) => updates(message as Map__Operations_ScrollBy));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_ScrollBy create() => Map__Operations_ScrollBy._();
  Map__Operations_ScrollBy createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_ScrollBy> createRepeated() =>
      $pb.PbList<Map__Operations_ScrollBy>();
  static Map__Operations_ScrollBy getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Map__Operations_SetFocalBearing extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      'Map.Operations.SetFocalBearing',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<$core.double>(1, 'bearing', $pb.PbFieldType.OD)
  ...
  factory Map__Operations_SetFocalBearing.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_SetFocalBearing.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_SetFocalBearing clone() =>
      Map__Operations_SetFocalBearing()..mergeFromMessage(this);
  Map__Operations_SetFocalBearing copyWith(
          void Function(Map__Operations_SetFocalBearing) updates) =>
      super.copyWith(
          (message) => updates(message as Map__Operations_SetFocalBearing));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_SetFocalBearing create() =>
      Map__Operations_SetFocalBearing._();
  Map__Operations_SetFocalBearing createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_SetFocalBearing> createRepeated() =>
      $pb.PbList<Map__Operations_SetFocalBearing>();
  static Map__Operations_SetFocalBearing getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Map__Operations_GetCameraForLatLngBounds extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      'Map.Operations.GetCameraForLatLngBounds',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<$1.LatLngBounds>(1, 'bounds', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLngBounds.getDefault,
        subBuilder: $1.LatLngBounds.create)
  ...
  factory Map__Operations_GetCameraForLatLngBounds.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations_GetCameraForLatLngBounds.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations_GetCameraForLatLngBounds clone() =>
      Map__Operations_GetCameraForLatLngBounds()..mergeFromMessage(this);
  Map__Operations_GetCameraForLatLngBounds copyWith(
          void Function(Map__Operations_GetCameraForLatLngBounds) updates) =>
      super.copyWith((message) =>
          updates(message as Map__Operations_GetCameraForLatLngBounds));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations_GetCameraForLatLngBounds create() =>
      Map__Operations_GetCameraForLatLngBounds._();
  Map__Operations_GetCameraForLatLngBounds createEmptyInstance() => create();
  static $pb.PbList<Map__Operations_GetCameraForLatLngBounds>
      createRepeated() =>
          $pb.PbList<Map__Operations_GetCameraForLatLngBounds>();
  static Map__Operations_GetCameraForLatLngBounds getDefault() =>
      _defaultInstance ??= create()..freeze();
...
class Map__Operations extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map.Operations',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  factory Map__Operations.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map__Operations.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map__Operations clone() => Map__Operations()..mergeFromMessage(this);
  Map__Operations copyWith(void Function(Map__Operations) updates) =>
      super.copyWith((message) => updates(message as Map__Operations));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Map__Operations create() => Map__Operations._();
  Map__Operations createEmptyInstance() => create();
  static $pb.PbList<Map__Operations> createRepeated() =>
      $pb.PbList<Map__Operations>();
  static Map__Operations getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Map__Operations _defaultInstance;
}

class Map_ extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Map',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  Map_._() : super();
  factory Map_() => create();
  factory Map_.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Map_.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Map_ clone() => Map_()..mergeFromMessage(this);
  Map_ copyWith(void Function(Map_) updates) =>
      super.copyWith((message) => updates(message as Map_));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
