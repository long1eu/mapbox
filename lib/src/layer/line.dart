...
abstract class LineLayer with _Channel implements Layer, Built<LineLayer, LineLayerBuilder> {
  factory LineLayer({
    @required String id,
  ...
  factory LineLayer.fromProto(pb.Layer_Line proto) {
    return _$LineLayer((LineLayerBuilder b) {
      b
        ...
        ..miterLimit = proto.hasMiterLimit() ? Expression.fromProtoString(proto.miterLimit) : null
        ..roundLimit = proto.hasRoundLimit() ? Expression.fromProtoString(proto.roundLimit) : null
        ...
        ..width = proto.hasWidth() ? Expression.fromProtoString(proto.width) : null
        ..gapWidth = proto.hasGapWidth() ? Expression.fromProtoString(proto.gapWidth) : null
        ..offset = proto.hasOffset() ? Expression.fromProtoString(proto.offset) : null
        ..blur = proto.hasBlur() ? Expression.fromProtoString(proto.blur) : null
        ..dasharray = proto.hasDasharray() ? Expression.fromProtoString(proto.dasharray) : null
        ..pattern = proto.hasPattern() ? Expression.fromProtoString(proto.pattern) : null
        ..gradient = proto.hasGradient() ? Expression.fromProtoString(proto.gradient) : null
  ...
  FutureOr<LineLayer> copyWith({
    ...
    final LineLayer layer = rebuild((LineLayerBuilder b) {
      return b
        ...
        ..widthTransition = (widthTransition ?? this.widthTransition).toBuilder()
        ..gapWidthTransition = (gapWidthTransition ?? this.gapWidthTransition).toBuilder()
        ..offsetTransition = (offsetTransition ?? this.offsetTransition).toBuilder()
        ..blurTransition = (blurTransition ?? this.blurTransition).toBuilder()
        ..dasharrayTransition = (dasharrayTransition ?? this.dasharrayTransition).toBuilder()
    ...
    if (layer is LineLayer) {
      return rebuild((b) {
        b
          ...
          ..widthTransition = (layer.widthTransition ?? widthTransition).toBuilder()
          ..gapWidthTransition = (layer.gapWidthTransition ?? gapWidthTransition).toBuilder()
          ..offsetTransition = (layer.offsetTransition ?? offsetTransition).toBuilder()
          ..blurTransition = (layer.blurTransition ?? blurTransition).toBuilder()
          ..dasharrayTransition = (layer.dasharrayTransition ?? dasharrayTransition).toBuilder()
          ..patternTransition = (layer.patternTransition ?? patternTransition).toBuilder();
      });
    } else {
      throw ArgumentError('Only a LineLayer can be merged but got ${layer.runtimeType}');
    }
  }
