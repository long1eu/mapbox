...
abstract class SymbolLayer
  ...
  factory SymbolLayer({
                        ...
                        SymbolAlignment iconRotationAlignment = SymbolAlignment
                            .auto,
                        ...
                        SymbolAlignment iconPitchAlignment = SymbolAlignment
                            .auto,
                        Expression iconPitchAlignmentEx,
                        SymbolAlignment textPitchAlignment = SymbolAlignment
                            .auto,
                        Expression textPitchAlignmentEx,
                        SymbolAlignment textRotationAlignment = SymbolAlignment
                            .auto,
                        ...
                        SymbolTextJustify textJustify = SymbolTextJustify
                            .center,
                        ...
                        SymbolTextTransform textTransform = SymbolTextTransform
                            .none,
                        ...
                        TranslateAnchor iconTranslateAnchor = TranslateAnchor
                            .map,
                        ...
                        TranslateAnchor textTranslateAnchor = TranslateAnchor
                            .map,
    ...
    if (iconOffset != null)
      assert(iconOffset.dx != null && iconOffset.dy != null);
    if (textSize != null) assert(textSize >= 0);
    if (textMaxWidth != null) assert(textMaxWidth >= 0);
    if (textOffset != null)
      assert(textOffset.dx != null && textOffset.dy != null);
    ...
    if (iconTranslate != null)
      assert(iconTranslate.dx != null && iconTranslate.dy != null);
    ...
    if (textTranslate != null)
      assert(textTranslate.dx != null && textTranslate.dy != null);
    ...
    return _$SymbolLayer((SymbolLayerBuilder b) {
      b
        ...
        ..filter = filter
        ..symbolPlacement = symbolPlacementEx ??
                            (symbolPlacement != null ? symbolPlacement : null)
        ..symbolSpacing = symbolSpacingEx ??
                          (symbolSpacing != null
                           ? literalDouble(symbolSpacing)
                           : null)
        ..symbolAvoidEdges = symbolAvoidEdgesEx ??
                             (symbolAvoidEdges != null ? literalBool(
                                 symbolAvoidEdges) : null)
        ..symbolZOrder =
            symbolZOrderEx ?? (symbolZOrder != null ? symbolZOrder : null)
        ..iconAllowOverlap = iconAllowOverlapEx ??
                             (iconAllowOverlap != null ? literalBool(
        ...
        ..iconTextFit =
            iconTextFitEx ?? (iconTextFit != null ? iconTextFit : null)
        ...
        ..iconKeepUpright = iconKeepUprightEx ??
                            (iconKeepUpright != null ? literalBool(
        ...
        ..textLineHeight = textLineHeightEx ??
                           (textLineHeight != null ? literalDouble(
                               textLineHeight) : null)
        ..textLetterSpacing = textLetterSpacingEx ??
                              (textLetterSpacing != null
                               ...
                               : null)
        ..textJustify =
            textJustifyEx ?? (textJustify != null ? textJustify : null)
        ..textRadialOffset = textRadialOffsetEx ??
                             (textRadialOffset != null ? literalDouble(
        ...
        ..iconHaloColor = iconHaloColorEx ??
                          (iconHaloColor != null
                           ? rgb(
                              iconHaloColor.red, iconHaloColor.green,
                              iconHaloColor.blue)
                           : null)
        ...
        ..iconTranslate = iconTranslateEx ??
                          (iconTranslate != null
                           ? literalList(
                              <double>[iconTranslate.dx, iconTranslate.dy])
                           : null)
        ...
        ..textHaloColor = textHaloColorEx ??
                          (textHaloColor != null
                           ? rgb(
                              textHaloColor.red, textHaloColor.green,
                              textHaloColor.blue)
                           : null)
        ..textHaloWidth = textHaloWidthEx ??
                          (textHaloWidth != null
                           ? literalDouble(textHaloWidth)
                           : null)
        ..textHaloBlur = textHaloBlurEx ??
                         (textHaloBlur != null
                          ? literalDouble(textHaloBlur)
                          : null)
        ..textTranslate = textTranslateEx ??
                          (textTranslate != null
                           ? literalList(
                              <double>[textTranslate.dx, textTranslate.dy])
                           : null)
        ..textTranslateAnchor = textTranslateAnchorEx ??
                                (textTranslateAnchor != null
                                 ? textTranslateAnchor
                                 : null)
        ..iconOpacityTransition = (iconOpacityTransition ?? transitionOptions)
            .toBuilder()
        ..iconColorTransition = (iconColorTransition ?? transitionOptions)
            .toBuilder()
        ..iconHaloColorTransition = (iconHaloColorTransition ??
                                     transitionOptions).toBuilder()
        ..iconHaloWidthTransition = (iconHaloWidthTransition ??
                                     transitionOptions).toBuilder()
        ..iconHaloBlurTransition = (iconHaloBlurTransition ?? transitionOptions)
            .toBuilder()
        ..iconTranslateTransition = (iconTranslateTransition ??
                                     transitionOptions).toBuilder()
        ..textOpacityTransition = (textOpacityTransition ?? transitionOptions)
            .toBuilder()
        ..textColorTransition = (textColorTransition ?? transitionOptions)
            .toBuilder()
        ..textHaloColorTransition = (textHaloColorTransition ??
                                     transitionOptions).toBuilder()
        ..textHaloWidthTransition = (textHaloWidthTransition ??
                                     transitionOptions).toBuilder()
        ..textHaloBlurTransition = (textHaloBlurTransition ?? transitionOptions)
            .toBuilder()
        ..textTranslateTransition = (textTranslateTransition ??
                                     transitionOptions).toBuilder();
    });
  }
    ...
    return _$SymbolLayer((SymbolLayerBuilder b) {
      b
        ...
        ..symbolAvoidEdges = proto.hasSymbolAvoidEdges()
                             ? Expression.fromProtoString(
            proto.symbolAvoidEdges)
                             : null
        ...
        ..textRadialOffset = proto.hasTextRadialOffset()
                             ? Expression.fromProtoString(
            proto.textRadialOffset)
                             : null
        ..textVariableAnchor = proto.hasTextVariableAnchor()
                               ? Expression.fromProtoString(
            proto.textVariableAnchor)
                               : null
        ...
        ..iconHaloBlurTransition = TransitionOptions.fromProto(
            proto.iconHaloBlurTransition).toBuilder()
        ..iconTranslateTransition = TransitionOptions.fromProto(
            proto.iconTranslateTransition).toBuilder()
        ..textOpacityTransition = TransitionOptions.fromProto(
            proto.textOpacityTransition).toBuilder()
        ..textColorTransition = TransitionOptions.fromProto(
            proto.textColorTransition).toBuilder()
        ..textHaloColorTransition = TransitionOptions.fromProto(
            proto.textHaloColorTransition).toBuilder()
        ..textHaloWidthTransition = TransitionOptions.fromProto(
            proto.textHaloWidthTransition).toBuilder()
        ..textHaloBlurTransition = TransitionOptions.fromProto(
            proto.textHaloBlurTransition).toBuilder()
        ..textTranslateTransition = TransitionOptions.fromProto(
            proto.textTranslateTransition).toBuilder();
    });
  }
  ...
  FutureOr<SymbolLayer> copyWith({
    ...
    final SymbolLayer layer = rebuild((SymbolLayerBuilder b) {
      return b
        ...
        ..symbolPlacement = symbolPlacementEx ??
                            (symbolPlacement != null ? symbolPlacement : this
                                .symbolPlacement)
        ..symbolSpacing = symbolSpacingEx ??
                          (symbolSpacing != null
                           ? literalDouble(symbolSpacing)
        ...
        ..symbolZOrder = symbolZOrderEx ??
                         (symbolZOrder != null ? symbolZOrder : this
                             .symbolZOrder)
        ..iconAllowOverlap = iconAllowOverlapEx ??
                             (iconAllowOverlap != null
        ...
        ..iconSize = iconSizeEx ??
                     (iconSize != null ? literalDouble(iconSize) : this
                         .iconSize)
        ...
        ..iconImage = iconImageEx ??
                      (iconImage != null ? literalString(iconImage) : this
                          .iconImage)
        ..iconRotate = iconRotateEx ??
                       (iconRotate != null ? literalDouble(iconRotate) : this
                           .iconRotate)
        ..iconPadding = iconPaddingEx ??
                        (iconPadding != null
                         ? literalDouble(iconPadding)
        ...
        ..iconOffset = iconOffsetEx ??
                       (iconOffset != null
                        ...
                        : this.iconOffset)
        ..iconAnchor =
            iconAnchorEx ?? (iconAnchor != null ? iconAnchor : this.iconAnchor)
        ..iconPitchAlignment = iconPitchAlignmentEx ??
                               (iconPitchAlignment != null
                                ? iconPitchAlignment
        ...
        ..textSize = textSizeEx ??
                     (textSize != null ? literalDouble(textSize) : this
                         .textSize)
        ..textMaxWidth = textMaxWidthEx ??
                         (textMaxWidth != null
                          ? literalDouble(textMaxWidth)
        ...
        ..textJustify = textJustifyEx ??
                        (textJustify != null ? textJustify : this.textJustify)
        ..textRadialOffset = textRadialOffsetEx ??
                             (textRadialOffset != null
        ...
        ..textAnchor =
            textAnchorEx ?? (textAnchor != null ? textAnchor : this.textAnchor)
        ..textMaxAngle = textMaxAngleEx ??
                         (textMaxAngle != null
                          ? literalDouble(textMaxAngle)
                          : this.textMaxAngle)
        ..textRotate = textRotateEx ??
                       (textRotate != null ? literalDouble(textRotate) : this
                           .textRotate)
        ..textPadding = textPaddingEx ??
                        (textPadding != null
                         ? literalDouble(textPadding)
        ...
        ..textTransform = textTransformEx ??
                          (textTransform != null ? textTransform : this
                              .textTransform)
        ..textOffset = textOffsetEx ??
                       (textOffset != null
                        ? literalList(<double>[textOffset.dx, textOffset.dy])
        ...
        ..iconColor = iconColorEx ??
                      (iconColor != null
                       ...
                       : this.iconColor)
        ..iconHaloColor = iconHaloColorEx ??
                          (iconHaloColor != null ? rgb(
                              iconHaloColor.red, iconHaloColor.green,
                              iconHaloColor.blue) : this.iconHaloColor)
        ..iconHaloWidth = iconHaloWidthEx ?? (iconHaloWidth != null
                                              ? literalDouble(iconHaloWidth)
                                              : this.iconHaloWidth)
        ..iconHaloBlur = iconHaloBlurEx ?? (iconHaloBlur != null
                                            ? literalDouble(iconHaloBlur)
                                            : this.iconHaloBlur)
        ..iconTranslate = iconTranslateEx ??
                          (iconTranslate != null
        ...
        ..textOpacity = textOpacityEx ??
                        (textOpacity != null ? literalDouble(textOpacity) : this
                            .textOpacity)
        ..textColor = textColorEx ?? (textColor != null ? rgb(
            textColor.red, textColor.green, textColor.blue) : this.textColor)
        ..textHaloColor = textHaloColorEx ?? (textHaloColor != null ? rgb(
            textHaloColor.red, textHaloColor.green, textHaloColor.blue) : this
                                                  .textHaloColor)
        ..textHaloWidth = textHaloWidthEx ?? (textHaloWidth != null
                                              ? literalDouble(textHaloWidth)
                                              : this.textHaloWidth)
        ..textHaloBlur = textHaloBlurEx ?? (textHaloBlur != null
                                            ? literalDouble(textHaloBlur)
                                            : this.textHaloBlur)
        ..textTranslate = textTranslateEx ??
                          (textTranslate != null
        ...
        ..iconOpacityTransition = (iconOpacityTransition ??
                                   this.iconOpacityTransition).toBuilder()
        ..iconColorTransition = (iconColorTransition ??
                                 this.iconColorTransition).toBuilder()
        ..iconHaloColorTransition = (iconHaloColorTransition ??
                                     this.iconHaloColorTransition).toBuilder()
        ..iconHaloWidthTransition = (iconHaloWidthTransition ??
                                     this.iconHaloWidthTransition).toBuilder()
        ..iconHaloBlurTransition = (iconHaloBlurTransition ??
                                    this.iconHaloBlurTransition).toBuilder()
        ..iconTranslateTransition = (iconTranslateTransition ??
                                     this.iconTranslateTransition).toBuilder()
        ..textOpacityTransition = (textOpacityTransition ??
                                   this.textOpacityTransition).toBuilder()
        ..textColorTransition = (textColorTransition ??
                                 this.textColorTransition).toBuilder()
        ..textHaloColorTransition = (textHaloColorTransition ??
                                     this.textHaloColorTransition).toBuilder()
        ..textHaloWidthTransition = (textHaloWidthTransition ??
                                     this.textHaloWidthTransition).toBuilder()
        ..textHaloBlurTransition = (textHaloBlurTransition ??
                                    this.textHaloBlurTransition).toBuilder()
        ..textTranslateTransition = (textTranslateTransition ??
                                     this.textTranslateTransition).toBuilder();
    });
      ...
      return rebuild((SymbolLayerBuilder b) {
        if (layer != null) {
          b
            ...
            ..iconTextFitPadding = layer.iconTextFitPadding ??
                                   iconTextFitPadding
            ...
            ..iconPitchAlignment = layer.iconPitchAlignment ??
                                   iconPitchAlignment
            ..textPitchAlignment = layer.textPitchAlignment ??
                                   textPitchAlignment
            ..textRotationAlignment =
            ...
            ..textVariableAnchor = layer.textVariableAnchor ??
                                   textVariableAnchor
  ...
  pb.Layer_Symbol get proto {
    ...
    if (symbolZOrder != null) message.symbolZOrder = symbolZOrder.protoString;
    ...
    if (iconOptional != null) message.iconOptional = iconOptional.protoString;
    if (iconRotationAlignment != null)
      message.iconRotationAlignment = iconRotationAlignment.protoString;
    if (iconSize != null) message.iconSize = iconSize.protoString;
    if (iconTextFit != null) message.iconTextFit = iconTextFit.protoString;
    if (iconTextFitPadding != null)
      message.iconTextFitPadding = iconTextFitPadding.protoString;
    if (iconImage != null) message.iconImage = iconImage.protoString;
    if (iconRotate != null) message.iconRotate = iconRotate.protoString;
    if (iconPadding != null) message.iconPadding = iconPadding.protoString;
    if (iconKeepUpright != null)
      message.iconKeepUpright = iconKeepUpright.protoString;
    if (iconOffset != null) message.iconOffset = iconOffset.protoString;
    if (iconAnchor != null) message.iconAnchor = iconAnchor.protoString;
    ...
    if (textField != null) message.textField = textField.protoString;
    if (textFont != null) message.textFont = textFont.protoString;
    if (textSize != null) message.textSize = textSize.protoString;
    if (textMaxWidth != null) message.textMaxWidth = textMaxWidth.protoString;
    ...
    if (textJustify != null) message.textJustify = textJustify.protoString;
    ...
    if (textAnchor != null) message.textAnchor = textAnchor.protoString;
    if (textMaxAngle != null) message.textMaxAngle = textMaxAngle.protoString;
    if (textRotate != null) message.textRotate = textRotate.protoString;
    if (textPadding != null) message.textPadding = textPadding.protoString;
    ...
    if (textOffset != null) message.textOffset = textOffset.protoString;
    ...
    if (textOptional != null) message.textOptional = textOptional.protoString;
    if (iconOpacity != null) message.iconOpacity = iconOpacity.protoString;
    if (iconColor != null) message.iconColor = iconColor.protoString;
    ...
    if (iconHaloBlur != null) message.iconHaloBlur = iconHaloBlur.protoString;
    if (iconTranslate != null)
    ...
    if (textOpacity != null) message.textOpacity = textOpacity.protoString;
    if (textColor != null) message.textColor = textColor.protoString;
    ...
    if (textHaloBlur != null) message.textHaloBlur = textHaloBlur.protoString;
    if (textTranslate != null)
