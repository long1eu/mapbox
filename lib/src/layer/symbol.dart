    ...
    return _$SymbolLayer((SymbolLayerBuilder b) {
      b
        ...
        ..textField = textFieldEx ??
                      (textField != null
                       ? format(
                          textField.map((FormattedSection it) => it.expression)
                              .toList())
                       : null) ??
        ...
        ..textTranslate = textTranslateEx ??
                          (textTranslate != null
                           ...
                           : null)
        ..textTranslateAnchor =
            textTranslateAnchorEx ??
            (textTranslateAnchor != null ? textTranslateAnchor : null)
  ...
  FutureOr<SymbolLayer> copyWith({
    ...
    final SymbolLayer layer = rebuild((SymbolLayerBuilder b) {
      return b
        ...
        ..iconHaloColor = iconHaloColorEx ??
                          (iconHaloColor != null
                           ? rgb(iconHaloColor.red, iconHaloColor.green,
                              iconHaloColor.blue)
                           : this.iconHaloColor)
