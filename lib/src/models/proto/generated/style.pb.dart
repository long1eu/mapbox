...
class Style_Light extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.Light',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..e<$1.TranslateAnchor>(1, 'anchor', $pb.PbFieldType.OE,
        defaultOrMaker: $1.TranslateAnchor.MAP,
        valueOf: $1.TranslateAnchor.valueOf,
        enumValues: $1.TranslateAnchor.values)
    ..a<Style_Position>(2, 'position', $pb.PbFieldType.OM,
        defaultOrMaker: Style_Position.getDefault,
        subBuilder: Style_Position.create)
    ..a<$1.Color>(3, 'color', $pb.PbFieldType.OM,
        defaultOrMaker: $1.Color.getDefault, subBuilder: $1.Color.create)
    ..a<$core.double>(4, 'intensity', $pb.PbFieldType.OF)
    ..a<$1.TransitionOptions>(5, 'positionTransition', $pb.PbFieldType.OM,
        protoName: 'positionTransition',
        defaultOrMaker: $1.TransitionOptions.getDefault,
        subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(6, 'colorTransition', $pb.PbFieldType.OM,
        protoName: 'colorTransition',
        defaultOrMaker: $1.TransitionOptions.getDefault,
        subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(7, 'intensityTransition', $pb.PbFieldType.OM,
        protoName: 'intensityTransition',
        defaultOrMaker: $1.TransitionOptions.getDefault,
        subBuilder: $1.TransitionOptions.create)
  ...
  factory Style_Light.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_Light.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_Light clone() => Style_Light()..mergeFromMessage(this);
  Style_Light copyWith(void Function(Style_Light) updates) =>
      super.copyWith((message) => updates(message as Style_Light));
  ...
  set anchor($1.TranslateAnchor v) {
    setField(1, v);
  }
  ...
  set positionTransition($1.TransitionOptions v) {
    setField(5, v);
  }
...
class Style_Position extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.Position',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
  ...
  factory Style_Position.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_Position.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_Position clone() => Style_Position()..mergeFromMessage(this);
  Style_Position copyWith(void Function(Style_Position) updates) =>
      super.copyWith((message) => updates(message as Style_Position));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Style_Position create() => Style_Position._();
  Style_Position createEmptyInstance() => create();
  static $pb.PbList<Style_Position> createRepeated() =>
      $pb.PbList<Style_Position>();
  ...
  set radialCoordinate($core.double v) {
    $_setFloat(0, v);
  }
  ...
  set azimuthalAngle($core.double v) {
    $_setFloat(1, v);
  }
...
enum Style_StyleImage_Source { image, asset, notSet }

class Style_StyleImage extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Style_StyleImage_Source>
      _Style_StyleImage_SourceByTag = {
    2: Style_StyleImage_Source.image,
    3: Style_StyleImage_Source.asset,
    0: Style_StyleImage_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.StyleImage',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, 'id')
    ..a<$core.List<$core.int>>(2, 'image', $pb.PbFieldType.OY)
    ..a<Style_Asset>(3, 'asset', $pb.PbFieldType.OM,
        defaultOrMaker: Style_Asset.getDefault, subBuilder: Style_Asset.create)
    ..aOB(4, 'sdf')
    ..hasRequiredFields = false;

  Style_StyleImage._() : super();
  factory Style_StyleImage() => create();
  factory Style_StyleImage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_StyleImage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_StyleImage clone() => Style_StyleImage()..mergeFromMessage(this);
  Style_StyleImage copyWith(void Function(Style_StyleImage) updates) =>
      super.copyWith((message) => updates(message as Style_StyleImage));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Style_StyleImage create() => Style_StyleImage._();
  Style_StyleImage createEmptyInstance() => create();
  static $pb.PbList<Style_StyleImage> createRepeated() =>
      $pb.PbList<Style_StyleImage>();
  static Style_StyleImage getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Style_StyleImage _defaultInstance;

  Style_StyleImage_Source whichSource() =>
      _Style_StyleImage_SourceByTag[$_whichOneof(0)];
...
class Style_Asset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.Asset',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aOS(1, 'asset')
    ..a<$0.StringValue>(2, 'packageName', $pb.PbFieldType.OM,
  ...
  factory Style_Asset.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_Asset.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_Asset clone() => Style_Asset()..mergeFromMessage(this);
  Style_Asset copyWith(void Function(Style_Asset) updates) =>
      super.copyWith((message) => updates(message as Style_Asset));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  set packageName($0.StringValue v) {
    setField(2, v);
  }
...
enum Style_Operations_Build_Source { default_1, uri, json, notSet }

class Style_Operations_Build extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Style_Operations_Build_Source>
      _Style_Operations_Build_SourceByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.Operations.Build',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..e<Style_MapboxStyle>(1, 'default', $pb.PbFieldType.OE,
        defaultOrMaker: Style_MapboxStyle.MAPBOX_STREETS,
        valueOf: Style_MapboxStyle.valueOf,
        enumValues: Style_MapboxStyle.values)
    ..aOS(2, 'uri')
    ..aOS(3, 'json')
    ..hasRequiredFields = false;
  ...
  factory Style_Operations_Build.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_Operations_Build.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_Operations_Build clone() =>
      Style_Operations_Build()..mergeFromMessage(this);
  Style_Operations_Build copyWith(
          void Function(Style_Operations_Build) updates) =>
      super.copyWith((message) => updates(message as Style_Operations_Build));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Style_Operations_Build create() => Style_Operations_Build._();
  Style_Operations_Build createEmptyInstance() => create();
  static $pb.PbList<Style_Operations_Build> createRepeated() =>
      $pb.PbList<Style_Operations_Build>();
  static Style_Operations_Build getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Style_Operations_Build _defaultInstance;

  Style_Operations_Build_Source whichSource() =>
      _Style_Operations_Build_SourceByTag[$_whichOneof(0)];
  void clearSource() => clearField($_whichOneof(0));

  Style_MapboxStyle get default_1 => $_getN(0);
  set default_1(Style_MapboxStyle v) {
    setField(1, v);
  }
...
class Style_Operations extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style.Operations',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  factory Style_Operations.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style_Operations.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style_Operations clone() => Style_Operations()..mergeFromMessage(this);
  Style_Operations copyWith(void Function(Style_Operations) updates) =>
      super.copyWith((message) => updates(message as Style_Operations));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Style_Operations create() => Style_Operations._();
  Style_Operations createEmptyInstance() => create();
  static $pb.PbList<Style_Operations> createRepeated() =>
      $pb.PbList<Style_Operations>();
  static Style_Operations getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Style_Operations _defaultInstance;
}

class Style extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Style',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aOS(1, 'uri')
    ..aOS(2, 'json')
    ..pc<$2.Source>(3, 'sources', $pb.PbFieldType.PM,
        subBuilder: $2.Source.create)
    ..pc<$3.Layer>(4, 'layers', $pb.PbFieldType.PM, subBuilder: $3.Layer.create)
    ..a<$1.TransitionOptions>(5, 'transition', $pb.PbFieldType.OM,
        defaultOrMaker: $1.TransitionOptions.getDefault,
        subBuilder: $1.TransitionOptions.create)
    ..a<Style_Light>(6, 'light', $pb.PbFieldType.OM,
        defaultOrMaker: Style_Light.getDefault, subBuilder: Style_Light.create)
    ..hasRequiredFields = false;

  Style._() : super();
  factory Style() => create();
  factory Style.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Style.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Style clone() => Style()..mergeFromMessage(this);
  Style copyWith(void Function(Style) updates) =>
      super.copyWith((message) => updates(message as Style));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  set transition($1.TransitionOptions v) {
    setField(5, v);
  }
