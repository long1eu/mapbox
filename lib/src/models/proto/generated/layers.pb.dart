...
class Layer_Background extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Background', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.BoolValue>(2, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(3, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.FloatValue>(4, 'maxZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.StringValue>(5, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(6, 'pattern', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$1.TransitionOptions>(8, 'colorTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(9, 'patternTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(10, 'opacityTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
...
class Layer_Circle extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Circle', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.FloatValue>(5, 'maxZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'radius', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'blur', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'translate', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'translateAnchor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'pitchScale', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(15, 'pitchAlignment', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
...
class Layer_FillExtrusion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.FillExtrusion', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'translate', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'translateAnchor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'pattern', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'height', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'base', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(15, 'verticalGradient', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
...
class Layer_Fill extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Fill', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'antialias', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'outlineColor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'translate', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'translateAnchor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'pattern', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$1.TransitionOptions>(15, 'opacityTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
...
class Layer_Heatmap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Heatmap', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'radius', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'weight', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'intensity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$1.TransitionOptions>(13, 'radiusTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(14, 'intensityTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(15, 'opacityTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..hasRequiredFields = false
  ;
...
class Layer_Hillshade extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Hillshade', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.FloatValue>(5, 'maxZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'illuminationDirection', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'illuminationAnchor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'exaggeration', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'shadowColor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'highlightColor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'accentColor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$1.TransitionOptions>(13, 'exaggerationTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(14, 'shadowColorTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
    ..a<$1.TransitionOptions>(15, 'highlightColorTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
...
class Layer_Line extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Line', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'cap', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'join', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'miterLimit', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'roundLimit', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'color', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'translate', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(15, 'translateAnchor', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
...
class Layer_Raster extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Raster', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'opacity', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'hueRotate', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'brightnessMin', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'brightnessMax', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'saturation', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'contrast', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'resampling', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'fadeDuration', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$1.TransitionOptions>(15, 'opacityTransition', $pb.PbFieldType.OM, defaultOrMaker: $1.TransitionOptions.getDefault, subBuilder: $1.TransitionOptions.create)
...
class Layer_Symbol extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer.Symbol', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..a<$0.StringValue>(2, 'sourceId', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.BoolValue>(3, 'visible', $pb.PbFieldType.OM, defaultOrMaker: $0.BoolValue.getDefault, subBuilder: $0.BoolValue.create)
    ..a<$0.FloatValue>(4, 'minZoom', $pb.PbFieldType.OM, defaultOrMaker: $0.FloatValue.getDefault, subBuilder: $0.FloatValue.create)
    ...
    ..a<$0.StringValue>(6, 'sourceLayer', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(7, 'filter', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(8, 'symbolPlacement', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(9, 'symbolSpacing', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(10, 'symbolAvoidEdges', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(11, 'symbolZOrder', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(12, 'iconAllowOverlap', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(13, 'iconIgnorePlacement', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(14, 'iconOptional', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
    ..a<$0.StringValue>(15, 'iconRotationAlignment', $pb.PbFieldType.OM, defaultOrMaker: $0.StringValue.getDefault, subBuilder: $0.StringValue.create)
...
class Layer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Layer', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6, 7, 8, 9, 10])
    ..aOS(1, 'id')
    ..a<Layer_Background>(2, 'backgroundLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Background.getDefault, subBuilder: Layer_Background.create)
    ..a<Layer_Circle>(3, 'circleLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Circle.getDefault, subBuilder: Layer_Circle.create)
    ..a<Layer_Fill>(4, 'fillLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Fill.getDefault, subBuilder: Layer_Fill.create)
    ..a<Layer_FillExtrusion>(5, 'fillExtrusionLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_FillExtrusion.getDefault, subBuilder: Layer_FillExtrusion.create)
    ..a<Layer_Heatmap>(6, 'heatmapLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Heatmap.getDefault, subBuilder: Layer_Heatmap.create)
    ..a<Layer_Hillshade>(7, 'hillshadeLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Hillshade.getDefault, subBuilder: Layer_Hillshade.create)
    ..a<Layer_Line>(8, 'lineLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Line.getDefault, subBuilder: Layer_Line.create)
    ..a<Layer_Raster>(9, 'rasterLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Raster.getDefault, subBuilder: Layer_Raster.create)
    ..a<Layer_Symbol>(10, 'symbolLayer', $pb.PbFieldType.OM, defaultOrMaker: Layer_Symbol.getDefault, subBuilder: Layer_Symbol.create)
    ..hasRequiredFields = false
  ;
...
class Operations_Add extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Operations.Add', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..a<Layer>(1, 'layer', $pb.PbFieldType.OM, defaultOrMaker: Layer.getDefault, subBuilder: Layer.create)
    ..aOS(2, 'belowId')
    ..aOS(3, 'aboveId')
...
class Operations extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Operations', package: const $pb.PackageName('tophap.mapbox_gl'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
