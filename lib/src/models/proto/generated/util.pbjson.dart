...
const TranslateAnchor$json = const {
  '1': 'TranslateAnchor',
  '2': const [
    const {'1': 'MAP', '2': 0},
    const {'1': 'VIEWPORT', '2': 1},
  ],
};

const PositionAnchor$json = const {
  '1': 'PositionAnchor',
  '2': const [
    const {'1': 'POSITION_CENTER', '2': 0},
    const {'1': 'POSITION_LEFT', '2': 1},
    const {'1': 'POSITION_RIGHT', '2': 2},
    const {'1': 'POSITION_TOP', '2': 3},
    const {'1': 'POSITION_BOTTOM', '2': 4},
    const {'1': 'POSITION_TOP_LEFT', '2': 5},
    const {'1': 'POSITION_TOP_RIGHT', '2': 6},
    const {'1': 'POSITION_BOTTOM_LEFT', '2': 7},
    const {'1': 'POSITION_BOTTOM_RIGHT', '2': 8},
  ],
};

const FormattedSection$json = const {
  '1': 'FormattedSection',
  '2': const [
    ...
    const {'1': 'text_color', '3': 4, '4': 1, '5': 11, '6': '.com.tophap.mapbox_gl.proto.Color', '10': 'textColor'},
  ],
};

const TransitionOptions$json = const {
  '1': 'TransitionOptions',
  '2': const [
...
const LatLngQuad$json = const {
  '1': 'LatLngQuad',
  '2': const [
    const {'1': 'topLeft', '3': 1, '4': 1, '5': 11, '6': '.com.tophap.mapbox_gl.proto.LatLng', '10': 'topLeft'},
    const {'1': 'topRight', '3': 2, '4': 1, '5': 11, '6': '.com.tophap.mapbox_gl.proto.LatLng', '10': 'topRight'},
    const {'1': 'bottomRight', '3': 3, '4': 1, '5': 11, '6': '.com.tophap.mapbox_gl.proto.LatLng', '10': 'bottomRight'},
    const {'1': 'bottomLeft', '3': 4, '4': 1, '5': 11, '6': '.com.tophap.mapbox_gl.proto.LatLng', '10': 'bottomLeft'},
  ],
};
...
const Color$json = const {
  ...
  '2': const [
    ...
    const {'1': 'alpha', '3': 4, '4': 1, '5': 5, '10': 'alpha'},
    const {'1': 'opacity', '3': 5, '4': 1, '5': 2, '10': 'opacity'},
