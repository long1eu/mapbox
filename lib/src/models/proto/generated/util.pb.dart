...
class FormattedSection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FormattedSection', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..aOS(1, 'text')
...
class TransitionOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransitionOptions', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..aInt64(1, 'duration')
    ..aInt64(2, 'delay')
...
class LatLng extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLng', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
...
class LatLngQuad extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLngQuad', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
...
class LatLngBounds extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLngBounds', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
...
class Color extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Color', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
