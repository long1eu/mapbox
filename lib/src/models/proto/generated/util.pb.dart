...
class FormattedSection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FormattedSection',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aOS(1, 'text')
    ..a<$0.DoubleValue>(2, 'fontScale', $pb.PbFieldType.OM,
        defaultOrMaker: $0.DoubleValue.getDefault,
        subBuilder: $0.DoubleValue.create)
    ..pPS(3, 'fontStack')
    ..a<Color>(4, 'textColor', $pb.PbFieldType.OM,
        defaultOrMaker: Color.getDefault, subBuilder: Color.create)
    ..hasRequiredFields = false;

  FormattedSection._() : super();
  factory FormattedSection() => create();
  factory FormattedSection.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FormattedSection.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  FormattedSection clone() => FormattedSection()..mergeFromMessage(this);
  FormattedSection copyWith(void Function(FormattedSection) updates) =>
      super.copyWith((message) => updates(message as FormattedSection));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FormattedSection create() => FormattedSection._();
  FormattedSection createEmptyInstance() => create();
  static $pb.PbList<FormattedSection> createRepeated() =>
      $pb.PbList<FormattedSection>();
  static FormattedSection getDefault() =>
...
class TransitionOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TransitionOptions',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aInt64(1, 'duration')
    ..aInt64(2, 'delay')
  ...
  factory TransitionOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransitionOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  TransitionOptions clone() => TransitionOptions()..mergeFromMessage(this);
  TransitionOptions copyWith(void Function(TransitionOptions) updates) =>
      super.copyWith((message) => updates(message as TransitionOptions));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TransitionOptions create() => TransitionOptions._();
  TransitionOptions createEmptyInstance() => create();
  static $pb.PbList<TransitionOptions> createRepeated() =>
      $pb.PbList<TransitionOptions>();
  static TransitionOptions getDefault() =>
      _defaultInstance ??= create()..freeze();
  ...
  set enablePlacementTransitions($core.bool v) {
    $_setBool(2, v);
  }
...
class LatLngQuad extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLngQuad',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..a<LatLng>(1, 'topLeft', $pb.PbFieldType.OM,
        defaultOrMaker: LatLng.getDefault, subBuilder: LatLng.create)
    ..a<LatLng>(2, 'topRight', $pb.PbFieldType.OM,
        defaultOrMaker: LatLng.getDefault, subBuilder: LatLng.create)
    ..a<LatLng>(3, 'bottomRight', $pb.PbFieldType.OM,
        defaultOrMaker: LatLng.getDefault, subBuilder: LatLng.create)
    ..a<LatLng>(4, 'bottomLeft', $pb.PbFieldType.OM,
        defaultOrMaker: LatLng.getDefault, subBuilder: LatLng.create)
    ..hasRequiredFields = false;

  LatLngQuad._() : super();
  factory LatLngQuad() => create();
  factory LatLngQuad.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LatLngQuad.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  LatLngQuad clone() => LatLngQuad()..mergeFromMessage(this);
  LatLngQuad copyWith(void Function(LatLngQuad) updates) =>
      super.copyWith((message) => updates(message as LatLngQuad));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LatLngBounds extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LatLngBounds',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
