...
class Source_GeoJson_Options extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.GeoJson.Options',
  ...
  factory Source_GeoJson_Options.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_GeoJson_Options.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_GeoJson_Options clone() =>
      Source_GeoJson_Options()..mergeFromMessage(this);
  Source_GeoJson_Options copyWith(
          void Function(Source_GeoJson_Options) updates) =>
      super.copyWith((message) => updates(message as Source_GeoJson_Options));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_GeoJson_Options create() => Source_GeoJson_Options._();
  Source_GeoJson_Options createEmptyInstance() => create();
  static $pb.PbList<Source_GeoJson_Options> createRepeated() =>
      $pb.PbList<Source_GeoJson_Options>();
  static Source_GeoJson_Options getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Source_GeoJson_Options _defaultInstance;

  $core.int get minZoom => $_get(0, 0);
  set minZoom($core.int v) {
    $_setSignedInt32(0, v);
  }
...
enum Source_GeoJson_Source { uri, geoJson, notSet }

class Source_GeoJson extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Source_GeoJson_Source>
      _Source_GeoJson_SourceByTag = {
    4: Source_GeoJson_Source.uri,
    5: Source_GeoJson_Source.geoJson,
    0: Source_GeoJson_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.GeoJson',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, 'id')
    ..aOS(2, 'attribution')
    ..a<Source_GeoJson_Options>(3, 'options', $pb.PbFieldType.OM,
        defaultOrMaker: Source_GeoJson_Options.getDefault,
        subBuilder: Source_GeoJson_Options.create)
    ..aOS(4, 'uri')
    ..aOS(5, 'geoJson')
    ..hasRequiredFields = false;
  ...
  factory Source_GeoJson.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_GeoJson.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_GeoJson clone() => Source_GeoJson()..mergeFromMessage(this);
  Source_GeoJson copyWith(void Function(Source_GeoJson) updates) =>
      super.copyWith((message) => updates(message as Source_GeoJson));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_GeoJson create() => Source_GeoJson._();
  Source_GeoJson createEmptyInstance() => create();
  static $pb.PbList<Source_GeoJson> createRepeated() =>
      $pb.PbList<Source_GeoJson>();
  static Source_GeoJson getDefault() => _defaultInstance ??= create()..freeze();
  static Source_GeoJson _defaultInstance;

  Source_GeoJson_Source whichSource() =>
      _Source_GeoJson_SourceByTag[$_whichOneof(0)];
  ...
  set options(Source_GeoJson_Options v) {
    setField(3, v);
  }
...
enum Source_Image_Source { uri, image, asset, notSet }

class Source_Image extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Source_Image_Source>
      _Source_Image_SourceByTag = {
    4: Source_Image_Source.uri,
    5: Source_Image_Source.image,
    6: Source_Image_Source.asset,
    0: Source_Image_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.Image',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [4, 5, 6])
    ..aOS(1, 'id')
    ..aOS(2, 'attribution')
    ..a<$1.LatLngQuad>(3, 'coordinates', $pb.PbFieldType.OM,
        defaultOrMaker: $1.LatLngQuad.getDefault,
        subBuilder: $1.LatLngQuad.create)
    ..aOS(4, 'uri')
  ...
  factory Source_Image.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_Image.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_Image clone() => Source_Image()..mergeFromMessage(this);
  Source_Image copyWith(void Function(Source_Image) updates) =>
      super.copyWith((message) => updates(message as Source_Image));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_Image create() => Source_Image._();
  Source_Image createEmptyInstance() => create();
  static $pb.PbList<Source_Image> createRepeated() =>
      $pb.PbList<Source_Image>();
  static Source_Image getDefault() => _defaultInstance ??= create()..freeze();
  static Source_Image _defaultInstance;

  Source_Image_Source whichSource() =>
      _Source_Image_SourceByTag[$_whichOneof(0)];
  void clearSource() => clearField($_whichOneof(0));
  ...
  set coordinates($1.LatLngQuad v) {
    setField(3, v);
  }
...
enum Source_RasterDem_Source { uri, tileSet, notSet }

class Source_RasterDem extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Source_RasterDem_Source>
      _Source_RasterDem_SourceByTag = {
    4: Source_RasterDem_Source.uri,
    5: Source_RasterDem_Source.tileSet,
    0: Source_RasterDem_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.RasterDem',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, 'id')
    ...
    ..aOS(4, 'uri')
    ..a<Source_TileSet>(5, 'tileSet', $pb.PbFieldType.OM,
        defaultOrMaker: Source_TileSet.getDefault,
        subBuilder: Source_TileSet.create)
    ..hasRequiredFields = false;

  Source_RasterDem._() : super();
  factory Source_RasterDem() => create();
  factory Source_RasterDem.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_RasterDem.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_RasterDem clone() => Source_RasterDem()..mergeFromMessage(this);
  Source_RasterDem copyWith(void Function(Source_RasterDem) updates) =>
      super.copyWith((message) => updates(message as Source_RasterDem));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_RasterDem create() => Source_RasterDem._();
  Source_RasterDem createEmptyInstance() => create();
  static $pb.PbList<Source_RasterDem> createRepeated() =>
      $pb.PbList<Source_RasterDem>();
  static Source_RasterDem getDefault() =>
      _defaultInstance ??= create()..freeze();
  static Source_RasterDem _defaultInstance;

  Source_RasterDem_Source whichSource() =>
      _Source_RasterDem_SourceByTag[$_whichOneof(0)];
  void clearSource() => clearField($_whichOneof(0));
...
enum Source_Raster_Source { uri, tileSet, notSet }

class Source_Raster extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Source_Raster_Source>
      _Source_Raster_SourceByTag = {
    4: Source_Raster_Source.uri,
    5: Source_Raster_Source.tileSet,
    0: Source_Raster_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.Raster',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, 'id')
  ...
  factory Source_Raster.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_Raster.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_Raster clone() => Source_Raster()..mergeFromMessage(this);
  Source_Raster copyWith(void Function(Source_Raster) updates) =>
      super.copyWith((message) => updates(message as Source_Raster));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_Raster create() => Source_Raster._();
  Source_Raster createEmptyInstance() => create();
  static $pb.PbList<Source_Raster> createRepeated() =>
      $pb.PbList<Source_Raster>();
  static Source_Raster getDefault() => _defaultInstance ??= create()..freeze();
  static Source_Raster _defaultInstance;

  Source_Raster_Source whichSource() =>
      _Source_Raster_SourceByTag[$_whichOneof(0)];
  void clearSource() => clearField($_whichOneof(0));
...
enum Source_Vector_Source { uri, tileSet, notSet }

class Source_Vector extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Source_Vector_Source>
      _Source_Vector_SourceByTag = {
    3: Source_Vector_Source.uri,
    4: Source_Vector_Source.tileSet,
    0: Source_Vector_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.Vector',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOS(1, 'id')
    ..aOS(2, 'attribution')
    ..aOS(3, 'uri')
    ..a<Source_TileSet>(4, 'tileSet', $pb.PbFieldType.OM,
        defaultOrMaker: Source_TileSet.getDefault,
        subBuilder: Source_TileSet.create)
    ..hasRequiredFields = false;
  ...
  factory Source_Vector.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_Vector.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_Vector clone() => Source_Vector()..mergeFromMessage(this);
  Source_Vector copyWith(void Function(Source_Vector) updates) =>
      super.copyWith((message) => updates(message as Source_Vector));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_Vector create() => Source_Vector._();
  Source_Vector createEmptyInstance() => create();
  static $pb.PbList<Source_Vector> createRepeated() =>
      $pb.PbList<Source_Vector>();
  static Source_Vector getDefault() => _defaultInstance ??= create()..freeze();
  static Source_Vector _defaultInstance;

  Source_Vector_Source whichSource() =>
      _Source_Vector_SourceByTag[$_whichOneof(0)];
  void clearSource() => clearField($_whichOneof(0));
...
class Source_Unknown extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.Unknown',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aOS(1, 'id')
    ..aOS(2, 'attribution')
  ...
  factory Source_Unknown.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_Unknown.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_Unknown clone() => Source_Unknown()..mergeFromMessage(this);
  Source_Unknown copyWith(void Function(Source_Unknown) updates) =>
      super.copyWith((message) => updates(message as Source_Unknown));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_Unknown create() => Source_Unknown._();
  Source_Unknown createEmptyInstance() => create();
  static $pb.PbList<Source_Unknown> createRepeated() =>
      $pb.PbList<Source_Unknown>();
...
class Source_TileSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source.TileSet',
      package: const $pb.PackageName('tophap.mapbox_gl'),
      createEmptyInstance: create)
    ..aOS(1, 'tileJson')
    ..aOS(2, 'name')
  ...
  factory Source_TileSet.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Source_TileSet.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  Source_TileSet clone() => Source_TileSet()..mergeFromMessage(this);
  Source_TileSet copyWith(void Function(Source_TileSet) updates) =>
      super.copyWith((message) => updates(message as Source_TileSet));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Source_TileSet create() => Source_TileSet._();
  Source_TileSet createEmptyInstance() => create();
  static $pb.PbList<Source_TileSet> createRepeated() =>
      $pb.PbList<Source_TileSet>();
...
enum Source_Type { geoJson, image, rasterDem, raster, vector, unknown, notSet }
...
class Source extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Source',
    ...
    ..oo(0, [2, 3, 4, 5, 6, 7])
    ..aOS(1, 'id')
    ..a<Source_GeoJson>(2, 'geoJson', $pb.PbFieldType.OM,
        protoName: 'geoJson',
        defaultOrMaker: Source_GeoJson.getDefault,
        subBuilder: Source_GeoJson.create)
    ..a<Source_Image>(3, 'image', $pb.PbFieldType.OM,
        defaultOrMaker: Source_Image.getDefault,
        subBuilder: Source_Image.create)
    ..a<Source_RasterDem>(4, 'rasterDem', $pb.PbFieldType.OM,
        defaultOrMaker: Source_RasterDem.getDefault,
        subBuilder: Source_RasterDem.create)
    ..a<Source_Raster>(5, 'raster', $pb.PbFieldType.OM,
        defaultOrMaker: Source_Raster.getDefault,
        subBuilder: Source_Raster.create)
    ..a<Source_Vector>(6, 'vector', $pb.PbFieldType.OM,
        defaultOrMaker: Source_Vector.getDefault,
        subBuilder: Source_Vector.create)
    ..a<Source_Unknown>(7, 'unknown', $pb.PbFieldType.OM,
        defaultOrMaker: Source_Unknown.getDefault,
        subBuilder: Source_Unknown.create)
    ..hasRequiredFields = false;
  ...
  set rasterDem(Source_RasterDem v) {
    setField(4, v);
  }
