...
const Source$json = const {
  ...
  '2': const [
    ...
    const {'1': 'geoJson', '3': 2, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.GeoJson', '9': 0, '10': 'geoJson'},
    const {'1': 'image', '3': 3, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.Image', '9': 0, '10': 'image'},
    const {'1': 'raster_dem', '3': 4, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.RasterDem', '9': 0, '10': 'rasterDem'},
    const {'1': 'raster', '3': 5, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.Raster', '9': 0, '10': 'raster'},
    const {'1': 'vector', '3': 6, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.Vector', '9': 0, '10': 'vector'},
    const {'1': 'unknown', '3': 7, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.Unknown', '9': 0, '10': 'unknown'},
  ],
  '3': const [Source_GeoJson$json, Source_Image$json, Source_RasterDem$json, Source_Raster$json, Source_Vector$json, Source_Unknown$json, Source_TileSet$json],
  '8': const [
    const {'1': 'type'},
  ],
};
...
const Source_GeoJson$json = const {
  ...
  '2': const [
    ...
    const {'1': 'options', '3': 3, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.GeoJson.Options', '10': 'options'},
...
const Source_Image$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'attribution', '3': 2, '4': 1, '5': 9, '10': 'attribution'},
    const {'1': 'coordinates', '3': 3, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.LatLngQuad', '10': 'coordinates'},
    const {'1': 'uri', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'uri'},
...
const Source_RasterDem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'uri', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'uri'},
    const {'1': 'tile_set', '3': 5, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.TileSet', '9': 0, '10': 'tileSet'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
const Source_Vector$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tile_set', '3': 4, '4': 1, '5': 11, '6': '.com.tophap.mapboxgl.proto.Source.TileSet', '9': 0, '10': 'tileSet'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
