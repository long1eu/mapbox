...
class Expression extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Expression', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..oo(0, [3, 4])
    ..aOS(1, 'operator')
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..oo(0, [1, 2, 3, 4, 5])
...
class ListValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListValue', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
...
class MapExpression extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MapExpression', package: const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..m<$core.String, Expression>(1, 'map', 'MapExpression.MapEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, Expression.create, null, null , const $pb.PackageName('com.tophap.mapbox_gl.proto'))
    ..hasRequiredFields = false
  ;
